...
|- 각 항목의 name은 반드시 아래 후보 목록에 표시된 음식명(간결명) 그대로 사용해. 화면에 보이는 이름(displayName)을 그대로 name으로 적어줘. 절대 raw foodNm(닭튀김_블랙시크릿 콤보 치킨 (S), 닭발구이_참숯닭발, 불고기전골_간편조리세트_서울식불고기전골 같은 전체 이름) 또는 다른 변형 이름으로 쓰지 마. 예를 들어 목록에 "- 불고기전골 [불고기전골]"이 있으면 name은 "불고기전골"만 적어줘.
...
- "개고기", "꼴뚜기", "말고기", "꿩", "닭껍데기" 같은 비호 식품은 절대 선택하지마.
